...
<html lang="ko" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>세종대학교 소프트웨어융합대학 :: 과별 게시판 :: 데이터사이언스학과 :: 학생회 소개</title>
  ...
  %>  
    ...
    <nav>
      <nav>
        ...
        <ul class="lnb_deps2">
             <li>
               <a href="data_science_introduce.jsp" class="jwxe_22350 active">학과 소개</a>
             </li>
             <li>
               <a href="data_science_student_council.jsp" class="jwxe_22351 ">학생회 소개</a>
            </li>
            <li>
               <a href="data_science_promotion.jsp" class="jwxe_22351 ">홍보</a>
            </li>
            <li>
               <a href="data_science_public_money.jsp" class="jwxe_22351 ">학생회비 내역</a>
            </li>
        </ul>
      </nav>
    </nav>
