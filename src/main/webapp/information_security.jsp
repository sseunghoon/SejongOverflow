...
<html lang="ko" dir="ltr">
  <head>
    <meta charset="utf-8">
<<<<<<< HEAD:SnS/WebContent/school_contests.jsp
    <title>세종대학교 소프트웨어융합대학 :: 홍보 :: 교내 공모전</title>
=======
    <title>세종대학교 소프트웨어융합대학 :: 과별 게시판 :: 정보보호학과</title>
>>>>>>> 42301f5fb714e241a53d3a04e66005ad76d58f5a:SnS/WebContent/information_security.jsp
  ...
  %>  
    ...
    <nav>
      <nav>
        ...
        <ul class="lnb_deps2">
             <li>
               <a href="information_security_introduce.jsp" class="jwxe_22350 active">학과 소개</a>
             </li>
             <li>
