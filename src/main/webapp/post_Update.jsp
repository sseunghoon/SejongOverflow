...
<section class="content">
    ...
    <form method="post" action="post_UpdateAction.jsp?boardID=<%=boardID %>&postID=<%=post.getPostID()%>">
        <table class="table table-bordered">
            ...
            <tr>
                <th>제목:</th>
                <td><input type="text" name="postTitle" maxlength="50" value="<%=post.getPostTitle()%>"
                           class="form-control"/></td>
            </tr>
            <% if (boardID == 2 || boardID == 3) { %>
            <tr>
                <th>코드:</th>
                <td><textarea cols="10" name="postContent" maxlength="2048" style="height:350px;"
                              class="form-control"><%=post.getPostCode()%></textarea></td>
            </tr>
            <% } %>
            <tr>
                <th>내용:</th>
                <td><textarea cols="10" name="postContent" maxlength="2048" style="height:350px;"
                              class="form-control"><%=post.getPostContent()%></textarea></td>
            </tr>
            <tr>
                <th>첨부파일:</th>
