 	...
 	<div class="col-md-12">
    	<div class="card card-plain table-plain-bg">
			<div class="card-header ">
				...
				<p style="display:inline-block;"class="card-category">접수받은 신고내용을 확인하고 처리할 수 있습니다.</p>				

				<div class="modal fade" id="confirmModal" tabindex="-1"
					role="dialog" aria-labelledby="confirmModal"
					aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="confirmModalLabel">게시판 업데이트</h5>
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
			...
			<div class="card-body table-full-width table-responsive">
				<table class="table table-hover">
					...
					<tbody>
						<%
							ArrayList<ReportDTO> list = reportDAO.getList();
							int boardLevel=0;
